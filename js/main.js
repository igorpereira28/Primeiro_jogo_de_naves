function start() { // Inicio da função start()
	...
	$("#inicio").hide(); //depois que da start, aparece na tela essas imagens abaixo - id puxando do css
    ...
    //Principais variáveis do jogo - som
    ...
    function gameOver() {
        ...
        "<div id='reinicia' class='botao' onClick=reiniciaJogo()><h3>Jogar Novamente</h3></div>");
